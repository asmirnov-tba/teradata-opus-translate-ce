...
tags:
  ...
  - onnx
  - teradata
base_model: Helsinki-NLP/opus-mt_tiny_spa-glg
---

> ⚠️ **See [Disclaimer](#disclaimer) below before using.**

# opus-mt_tiny_spa-glg
...
[Helsinki-NLP/opus-mt_tiny_spa-glg](https://huggingface.co/Helsinki-NLP/opus-mt_tiny_spa-glg),
...
| Reference | https://huggingface.co/Helsinki-NLP/opus-mt_tiny_spa-glg |
...
repo_id  = "sashamartin/opus-mt_tiny_spa-glg"
model_id = "opus-mt_tiny_spa-glg"          # used as BYOM model_id
