...
tags:
  ...
  - onnx
  - teradata
base_model: Helsinki-NLP/opus-mt_tiny_ara-eng
---

> ⚠️ **See [Disclaimer](#disclaimer) below before using.**

# opus-mt_tiny_ara-eng  🇸🇦 → 🇬🇧
...
[Helsinki-NLP/opus-mt_tiny_ara-eng](https://huggingface.co/Helsinki-NLP/opus-mt_tiny_ara-eng),
...
| Reference | https://huggingface.co/Helsinki-NLP/opus-mt_tiny_ara-eng |
...
repo_id  = "sashamartin/opus-mt_tiny_ara-eng"
model_id = "opus-mt_tiny_ara-eng"          # used as BYOM model_id
